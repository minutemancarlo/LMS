    ...
    SweetAlert.prototype.init = function () {
            ...
            swal(
                {
                    type: 'warning',
                    title: 'Oops...',
                    text: 'You cannot book beyond today',
                }
            )
        });

        $('#booksunday').click(function () {
            swal(
                {
                    type: 'warning',
                    title: 'Oops...',
                    text: 'You cannot book for sunday',
                }
            )
        });
        ...
        $('#login-success').click(function () {
            swal(
                {
                    title: 'Success',
                    text: 'Account accepted',
                    type: 'success',
                    showCancelButton: false,
                    confirmButtonClass: 'btn btn-success'
                }).then(function () {
                    // window.location.href=(window.location.origin+'/iPark');
                })
        });

        $('#rfid-success').click(function () {
            swal(
                {
                    title: 'Success',
                    text: 'Plate and RFID Updated',
                    type: 'success',
                    showCancelButton: false,
                    confirmButtonClass: 'btn btn-success'
                }).then(function () {
                    window.location.href=('https://dev.x10.bz/iPark/rfid.php');
                })
        });

        $('#somethingwentwrong').click(function () {
            swal(
                {
                    type: 'error',
                    title: 'Oops...',
